...
# Iniciar réplica
# Start-Process powershell -ArgumentList "-NoExit", "-Command", ".\distributedKV.exe --db-location=Medellin-r.db --http-addr=127.0.0.33:8080 --config-file=sharding.toml --shard=Medellin --replica"
