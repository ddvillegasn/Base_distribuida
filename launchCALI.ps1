...
# Iniciar réplica
Start-Process powershell -ArgumentList "-NoExit", "-Command", ".\distributedKV.exe --db-location=Cali-r.db --http-addr=10.1.1.4:8081 --config-file=sharding-distributed.toml --shard=Cali --replica"
